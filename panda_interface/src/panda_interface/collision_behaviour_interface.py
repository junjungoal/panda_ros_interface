...
class CollisionBehaviourInterface(object):
    ...
    def __init__(self):
        ...
        self._ft_collision_behaviour_handle = rospy.ServiceProxy("/franka_control/set_force_torque_collision_behavior", SetForceTorqueCollisionBehavior)
        self._full_collision_behaviour_handle = rospy.ServiceProxy("/franka_control/set_full_collision_behavior", SetForceTorqueCollisionBehavior)
